...
COMMANDS=(
    "python -m get_sim -sbatch 512 --sim_dir /work/hdd/bfly/txu8/project/HSP90-p23/finImagesStar -star /work/hdd/bfly/txu8/project/HSP90-p23/star/starfile_half1_truncate.star -pdb /work/hdd/bfly/txu8/project/HSP90-p23/pdb/final_walker_0.pdb --rotmode star -rot 200"
    ...
    "python -m get_sim -sbatch 512 --sim_dir /work/hdd/bfly/txu8/project/HSP90-p23/initImagesStar -star /work/hdd/bfly/txu8/project/HSP90-p23/star/starfile_half1_truncate.star -pdb /work/hdd/bfly/txu8/project/HSP90-p23/pdb/initial_model.pdb --rotmode star -rot 200"
